...
# 总插件数据库：可同步的插件资料库（所有电脑共享），位于 <库>/.pm/catalog.json
DB_FILENAME = "catalog.json"
DB_SCHEMA = 1
# 旧版（2.1 及以前）共享库文件名，升级时会被迁移并归档。
LEGACY_DB_FILENAME = "library.json"
